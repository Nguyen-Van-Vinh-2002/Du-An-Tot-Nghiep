    ...
    <div class="container">
      ...
      <div className="sort-filter row ">
        ...
        <div className="more-filter ms-1 col-12 col-sm-12 col-xl-5 col-lg-4 col-md-12 row mb-3">
          <div class="dropdown rounded-4 sort-select mt-2 col-6 col-sm-6 col-xl-4 col-lg-4 col-md-4 me-0 me-md-2 my-1 px-1">
          ...
          <div class="dropdown rounded-4 status-select mt-2 col-6 col-sm-6 col-xl-4 col-lg-4 col-md-4 me-0 me-md-2 my-1 px-1">
          ...
          <button class="btn btn-light rounded-4 border-0 mt-2 col-6 col-sm-6 col-xl-4 col-lg-6 col-md-3">So sánh</button>
        </div>
      </div>
    </div>
  );
